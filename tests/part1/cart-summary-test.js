...
describe('CartSummary', function() {
	...
	it('getSubtotalDisc() should return the sum of the price * quantity - disc 10% for all items', function() {
		var cartSummary = new CartSummary([
			{
				id: 1,
				quantity: 1,
		...
		expect(cartSummary.getSubtotalDisc()).to.equal(45);
	});
	...
	it('getCount', function() {
		...
		expect(cartSummary.getCount()).to.equal(1);
	});
